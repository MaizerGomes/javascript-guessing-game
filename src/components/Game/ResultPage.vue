<template>
  <div class="container">
    ...
    <button class="ripple-button button" @click="goToGames">
      Ver outros Jogos
    </button>
    <div class="custom-tweet-button">
      <a :href="`https://twitter.com/intent/tweet?text=${(twitterText)}`" target="_blank" alt="Tweetar a sua pntuação">
        <i class="btn-icon"></i>
        <span class="btn-text">Tweetar a sua pontuação</span>
      </a>
    </div>
    ...
    <div class="learning-suggestion" v-if="answerCount !== amount">
      ...
      <p>
        ...
        Clique em mim para aprender mais.
      </p>
    </div>
  </div>
</template>
