<template>
  <div class="login-root" v-if="firebaseFeedback">
    <button type="button" name="button" v-on:click="logIn" v-if="!user">Entrar via Facebook</button>
    ...
    <div class="menu-content" v-if="dropdownOpen && user">
      <div class="dropdown-menu">
        <div class="dropdown-header">
          Logado como <strong class="dropdown-name">{{user.displayName || user.email || 'Anonymous'}}</strong>
        </div>
